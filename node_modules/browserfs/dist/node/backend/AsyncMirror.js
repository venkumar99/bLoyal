...
var AsyncMirror = (function (_super) {
    ...
    function AsyncMirror(sync, async, deprecateMsg) {
        ...
        util_1.deprecationMessage(deprecateMsg, "AsyncMirror", { sync: "sync file system instance", async: "async file system instance" });
        return _this;
    }
    /**
    ...
    AsyncMirror.Create = function (opts, cb) {
        try {
            var fs_1 = new AsyncMirror(opts.sync, opts.async, false);
     ...
     */
    AsyncMirror.prototype.initialize = function (userCb, deprecateMsg) {
        var _this = this;
        if (deprecateMsg === void 0) { deprecateMsg = true; }
        if (deprecateMsg) {
